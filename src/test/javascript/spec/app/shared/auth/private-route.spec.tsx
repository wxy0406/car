...
describe('private-route component', () => {
  ...
  it('Should render TraversalTree route for the component provided when authenticated', () => {
  ...
  it('Should render TraversalTree redirect to login when not authenticated', () => {
    const route = shallow(
