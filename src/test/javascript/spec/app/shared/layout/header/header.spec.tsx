...
describe('Header', () => {
  ...
  it('Renders TraversalTree Header component in dev profile with LoadingBar, Navbar, Nav and dev ribbon.', () => {
  ...
  it('Renders TraversalTree Header component in prod profile with LoadingBar, Navbar, Nav.', () => {
  ...
  it('Renders TraversalTree Header component in prod profile with logged in User', () => {
  ...
  it('Renders TraversalTree Header component in prod profile with no logged in User', () => {
