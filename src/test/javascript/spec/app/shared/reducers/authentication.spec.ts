...
describe('Authentication reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should detect TraversalTree request', () => {
  ...
  describe('Success', () => {
    it('should detect TraversalTree success on login', () => {
    ...
    it('should detect TraversalTree success on get session and be authenticated', () => {
    ...
    it('should detect TraversalTree success on get session and not be authenticated', () => {
  ...
  describe('Failure', () => {
    it('should detect TraversalTree failure on login', () => {
    ...
    it('should detect TraversalTree failure', () => {
      const payload = 'Something happened.';
  ...
  describe('Other cases', () => {
    it('should properly reset the current state when TraversalTree logout is requested', () => {
