...
describe('Administration reducer tests', () => {
  ...
  describe('Success', () => {
    it('should update state according to TraversalTree successful fetch logs request', () => {
      const payload = {
        data: {
          loggers: {
            main: {
    ...
    it('should update state according to TraversalTree successful fetch health request', () => {
    ...
    it('should update state according to TraversalTree successful fetch metrics request', () => {
    ...
    it('should update state according to TraversalTree successful fetch thread dump request', () => {
    ...
    it('should update state according to TraversalTree successful fetch configurations request', () => {
    ...
    it('should update state according to TraversalTree successful fetch env request', () => {
    ...
    it('should update state according to TraversalTree successful fetch audits request', () => {
