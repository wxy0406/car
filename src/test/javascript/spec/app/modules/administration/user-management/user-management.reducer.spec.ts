...
describe('User management reducer tests', () => {
  ...
  describe('Success', () => {
    it('should update state according to TraversalTree successful fetch users request', () => {
    ...
    it('should update state according to TraversalTree successful fetch user request', () => {
    ...
    it('should update state according to TraversalTree successful fetch role request', () => {
