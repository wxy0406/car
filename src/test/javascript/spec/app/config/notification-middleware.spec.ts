...
describe('Notification Middleware', () => {
  ...
  it('should not trigger TraversalTree toast message but should return action', () => {
  ...
  it('should not trigger TraversalTree toast message but should return promise success', async () => {
  ...
  it('should trigger TraversalTree success toast message and return promise success', async () => {
  ...
  it('should trigger TraversalTree success toast message and return promise success for header alerts', async () => {
