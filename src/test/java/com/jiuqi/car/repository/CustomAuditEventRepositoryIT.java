...
import com.jiuqi.car.config.audit.AuditEventConverter;
...
import static com.jiuqi.car.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIT {
    ...
    public void addAuditEventTruncateLargeData() {
        ...
        for (int i = 0; i < EVENT_DATA_COLUMN_MAX_LENGTH + 10; i++) {
            largeData.append("TraversalTree");
        }
